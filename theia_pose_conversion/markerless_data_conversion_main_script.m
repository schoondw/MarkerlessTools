...
Opts = struct(...
    ...
    'qtm_format_output_folder', {{'qtm_data_path','theia_pose'}},... % Cell containing data_path (qtm_/theia_data_path, as defined in trial admin) and subfolder for storing converted data (QTM export format)
    'qtm_format_output_suffix', '',...
    'admin_file', 'admin.xlsx',... 'data_folder', 'Data',...
    'trial_sheet', 'trials',...
